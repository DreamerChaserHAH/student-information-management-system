...
\begin{DoxyCompactList}\small\item\em The entry point to the application that contains surface level logic. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
The entry point to the application that contains surface level logic. 
